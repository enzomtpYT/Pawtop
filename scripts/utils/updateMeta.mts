...
const latestReleaseInformation = await fetch("https://api.github.com/repos/enzomtpYT/Pawtop/releases/latest", {
    headers: {
...
const metaInfo = await fs.readFile("./meta/io.github.enzomtpyt.pawtop.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/io.github.enzomtpyt.pawtop.metainfo.xml", output, "utf-8");
