...
const releases = await fetch("https://api.github.com/repos/enzomtpYT/Pawtop/releases", {
    headers: {
...
const metaInfo = await (async () => {
    for (const release of releases) {
        const metaAsset = release.assets.find((a: any) => a.name === "io.github.enzomtpyt.pawtop.metainfo.xml");
...
await fs.writeFile("./dist/io.github.enzomtpyt.pawtop.metainfo.xml", output, "utf-8");
console.log("Updated meta information written to ./dist/io.github.enzomtpyt.pawtop.metainfo.xml");